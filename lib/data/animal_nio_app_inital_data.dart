...
List<AnimalType> animalTypesList = <AnimalType>[
  AnimalType(
    bgImage:
        'https://a-z-animals.com/media/2021/09/Species-Of-Mammals-header.jpg',
    tableName: "Mammals",
  ),
  AnimalType(
    tableName: "Birds",
    bgImage:
        "https://www.allaboutbirds.org/news/wp-content/uploads/2022/03/LB-TOC-banner-Spring-2022-nowords.jpg",
  ),
  AnimalType(
    tableName: "Fish",
    bgImage: "https://wallpapershome.com/images/pages/pic_h/20031.jpg",
  ),
  AnimalType(
    tableName: "Reptiles",
    bgImage:
        "https://www.thesprucepets.com/thmb/XSNyjhpzf4N9OVdhiFPYjiHa2CA=/4256x2394/smart/filters:no_upscale()/close-up-of-snake-on-tree-1004923464-5c29a95946e0fb00012e7bdd.jpg",
  ),
  AnimalType(
    tableName: "Amphibians",
    bgImage:
        "https://www.burkemuseum.org/sites/default/files/images/biology/herpetology/washington/pacific-tree-frog-1100x555.jpg",
  ),
  AnimalType(
    tableName: "Invertebrates",
    bgImage: "https://wallpapershome.com/images/pages/pic_h/932.jpg",
  ),
];
